...
VARIANTS = {"A": "artifacts/closed_loop_v2/tinyrdt_ema", "B": "artifacts/closed_loop_v3/B", "C": "artifacts/closed_loop_v3/C", "Bm": "artifacts/closed_loop_v3/Bm", "C40k": "artifacts/closed_loop_v3/C40k", "S": "artifacts/closed_loop_v3/S", "SD": "artifacts/closed_loop_v3/SD",
            "gripper_oracle": "artifacts/phase6/oracle/gripper_oracle", "arm_oracle": "artifacts/phase6/oracle/arm_oracle"}
COLORS = {"A": "#2a78d6", "B": "#eb6834", "C": "#1baf7a", "Bm": "#eda100", "C40k": "#4a3aa7", "S": "#e87ba4", "SD": "#e34948", "gripper_oracle": "#52514e", "arm_oracle": "#008300"}
LABELS = {"A": "A CLEAN10", "B": "B +PERTURB", "C": "C +DAGGER", "Bm": "Bm +PERTURB (size-matched to C)", "C40k": "C40k +DAGGER, 40k steps (follow-up)", "S": "S spatial tokens, CLEAN10", "SD": "SD state dropout 0.3, CLEAN10",
...
def main():
    ...
    for v in ("B", "C", "Bm", "C40k", "S", "SD", "gripper_oracle", "arm_oracle"):
