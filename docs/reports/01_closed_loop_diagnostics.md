...
## 14. Reproduction
```
scripts/experiments/run_closed_loop_diagnostics.sh                              # resumable sweep, 2 workers
...
```
Legacy-expert verification: the check in docs/research/research_log.md, Phase 4.
